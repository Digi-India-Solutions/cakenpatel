      ...
      <header>
        ...
        <div className={`rightNav ${sidetoggle ? "active" : ""} `}>
          <ul>
            ...
            {/* {hasAccess("allPromoBanner") && <li><Link to="/all-promo-banners" className={isActive('/all-promo-banners') ? 'click' : ''} onClick={handletoggleBtn}> <i class="fa-regular fa-images"></i> Manage Promo Banners</Link></li>} */}
            ...
            {hasAccess("allEvents") && <li><Link to="/all-events" className={isActive('/all-events') ? 'click' : ''} onClick={handletoggleBtn}> <i class="fa-solid fa-users"></i> All Events Images</Link></li>}
